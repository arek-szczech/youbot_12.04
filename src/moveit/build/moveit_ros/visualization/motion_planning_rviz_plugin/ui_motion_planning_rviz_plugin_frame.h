...
**
** Created: Tue Nov 7 16:03:15 2017
...
public:
    ...
    QLabel *label_101;
    QDoubleSpinBox *planning_attempts1;
    ...
    void setupUi(QWidget *MotionPlanningUI)
    {
        ...
        MotionPlanningUI->resize(688, 377);
        ...
        query_stackedwidgetPage2->setGeometry(QRect(0, 0, 218, 78));
        ...
        query_stackedwidgetPage1->setGeometry(QRect(0, 0, 218, 78));
        ...
        horizontalLayout_3->addWidget(planning_attempts);
        ...
        horizontalLayout_4->addWidget(label_101);

        planning_attempts1 = new QDoubleSpinBox(groupBox_10);
        planning_attempts1->setObjectName(QString::fromUtf8("planning_attempts1"));
        sizePolicy4.setHeightForWidth(planning_attempts1->sizePolicy().hasHeightForWidth());
        planning_attempts1->setSizePolicy(sizePolicy4);
        planning_attempts1->setMaximum(1000);
        planning_attempts1->setValue(10);

        horizontalLayout_4->addWidget(planning_attempts1);
        ...
        horizontalLayout_41->addWidget(object_rx);
        ...
        horizontalLayout_41->addWidget(object_ry);
        ...
        horizontalLayout_41->addWidget(object_rz);
    ...
    void retranslateUi(QWidget *MotionPlanningUI)
    {
        ...
        label_101->setText(QApplication::translate("MotionPlanningUI", "Planning Attempts:", 0, QApplication::UnicodeUTF8));

...
if(NOT "include;/opt/ros/hydro/include;/usr/include;/usr/include/eigen3" STREQUAL "")
  set(moveit_core_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/ros/hydro/include;/usr/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'moveit_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/arek/youbot/src/moveit/install/${idir}'.  Ask the maintainer 'Sachin Chitta <robot.moveit@gmail.com>, Ioan Sucan <isucan@gmail.com>, Acorn Pooley <acorn.pooley@sri.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/arek/youbot/src/moveit/install/lib;/home/arek/youbot_odwrotna_v3/devel/lib;/opt/ros/hydro/lib)
